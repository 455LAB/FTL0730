...
typedef struct
{
	...
	unsigned int rDMARAddress;
	unsigned int rDMAWAddress;
	unsigned int rFeature;
	unsigned int rCommandFail;
	unsigned int rNFCStatus;
	unsigned int rNandRBStatus;
	unsigned int rDelayTap;
} V2FMCRegisters;
